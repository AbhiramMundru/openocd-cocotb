...
#define BUILD_ESP_USB_JTAG 0

/* 0 if you do not want the Bitbang mode of FT232R based devices. */
#define BUILD_FT232R 0

/* 0 if you do not want the MPSSE mode of FTDI based devices. */
#define BUILD_FTDI 0

/* 0 if you do not want the cJTAG (OScan1, JScan3) tunneled thru MPSSE. */
#define BUILD_FTDI_CJTAG 0
...
/* #undef HAVE_LIBUSB_GET_PORT_NUMBERS */
